...
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel)
VALUES ('STU0010', N'Quế Ngọc Hải', '2003-05-15', 'Nam', N'Nghệ An', '0126226121', '034102929321', '1.5');
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel)
...
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel)
VALUES ('STU0013', N'Nguyễn Văn Quyết', '2001-07-01', 'Nam', N'Hồ Chí Minh', '0796226121', '015124929321', '1.5');
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel)
VALUES ('STU0014', N'Vũ Văn Thanh', '2004-04-14', 'Nam', N'Tứ Cường', '0406476121', '015102968321', '2.0');
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel) 
VALUES ('STU0015', N'Đoàn Văn Hậu', '2000-04-19', 'Nam', N'Hồ Chí Minh', '0406226121', '015102929321', '1.0');
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel) 
...
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel) 
VALUES ('STU0019', N'Nguyễn Phong Hồng Duy', '2002-06-13', 'Nam', N'Chơn Thành', '0508123456', '025162913426', '1.0');
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel) 
...
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel) 
VALUES ('STU0024', N'Bùi Hoàng Việt Anh', '2001-01-01', 'Nam', N'Thái Bình', '0404876121', '012152929321', '1.0');
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel) 
...
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel)
VALUES ('STU0028', N'Trần Đình Trọng', '2000-04-19', 'Nam', N'Hồ Chí Minh', '0406067121', '015100729321', '1.5');
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel)
...
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel)
VALUES ('STU0032', N'Hà Đức Chinh', '2004-09-22', 'Nam', N'Xuân Đài', '0401546121', '01510749321', '1.0');
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel) 
VALUES ('STU0033', N'Nguyễn Văn A', '2000-04-23', 'Nam', N'Hồ Chí Minh', '0176452121', '097102929311', '1.0');
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel) 
VALUES ('STU0034', N'Trần Minh Vương', '2000-03-28', 'Nam', N'Thụy Chính', '0428826121', '015289929321', '1.5');
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel) 
...
INSERT INTO HOCVIEN (MaHocVien, TenHocVien, NgaySinh, GioiTinh, DiaChi, SoDienThoai, ChungMinhNhanDan, RankLevel) 
VALUES ('STU0040', N'Lê Văn Xuân', '2000-04-23', 'Nam', N'Hồ Chí Minh', '0176452121', '097102929311', '1.0');
GO
...
/*Học viên lớp BS002*/
INSERT INTO HocVienTrongLop VALUES('BS002', 'STU0034')
INSERT INTO HocVienTrongLop VALUES('BS002', 'STU0010')
INSERT INTO HocVienTrongLop VALUES('BS002', 'STU0015')
INSERT INTO HocVienTrongLop VALUES('BS002', 'STU0040')
INSERT INTO HocVienTrongLop VALUES('BS002', 'STU0019')
INSERT INTO HocVienTrongLop VALUES('BS002', 'STU0028')
INSERT INTO HocVienTrongLop VALUES('BS002', 'STU0033')
INSERT INTO HocVienTrongLop VALUES('BS002', 'STU0024')
INSERT INTO HocVienTrongLop VALUES('BS002', 'STU0013')
INSERT INTO HocVienTrongLop VALUES('BS002', 'STU0032')

/*Học viên lớp PF001*/
INSERT INTO HocVienTrongLop VALUES('PF001', 'STU0004')
INSERT INTO HocVienTrongLop VALUES('PF001', 'STU0005')
INSERT INTO HocVienTrongLop VALUES('PF001', 'STU0007')
INSERT INTO HocVienTrongLop VALUES('PF001', 'STU0008')
INSERT INTO HocVienTrongLop VALUES('PF001', 'STU0014')
INSERT INTO HocVienTrongLop VALUES('PF001', 'STU0016')
INSERT INTO HocVienTrongLop VALUES('PF001', 'STU0018')
INSERT INTO HocVienTrongLop VALUES('PF001', 'STU0020')
INSERT INTO HocVienTrongLop VALUES('PF001', 'STU0022')
INSERT INTO HocVienTrongLop VALUES('PF001', 'STU0027')
